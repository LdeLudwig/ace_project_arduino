...
#define CALIBVAL1 -403190   // Valor RAW de calibração para a balança 1 (com 25g)
...
#define PESO_ITEM1 25       // Peso médio do item 1 (em gramas)
#define TOLERANCIA1 3       // Tolerância para o item 1 (±3g)
#define PESO_ITEM2 32       // Peso médio do item 2 (em gramas)
#define TOLERANCIA2 3       // Tolerância para o item 2 (±3g)
